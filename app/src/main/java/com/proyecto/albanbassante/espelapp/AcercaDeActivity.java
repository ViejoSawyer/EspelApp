...
public class AcercaDeActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search) {
            Intent i = new Intent(AcercaDeActivity.this, BusquedaActivity.class);
            startActivity(i);
        }
    ...
    public void setupNavigationDrawer() {
        ...
        AcercaDeActivity.this.getTheme().resolveAttribute(R.attr.colorPrimaryDark, typedValue, true);
    ...
    private void setupNavigationDrawerRecyclerViews() {
        ...
        linearLayoutManager = new LinearLayoutManager(AcercaDeActivity.this);
        ...
        linearLayoutManager2 = new LinearLayoutManager(AcercaDeActivity.this);
        ...
        linearLayoutManager3 = new LinearLayoutManager(AcercaDeActivity.this);
        ...
        linearLayoutManagerSettings = new LinearLayoutManager(AcercaDeActivity.this);
        ...
        itemClickSupport1.setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                ...
                Intent i = new Intent(AcercaDeActivity.this, DepartamentoInfoActivity.class);
                switch (position) {
                    case 0:
        ...
        itemClickSupport2.setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                ...
                Intent i = new Intent(AcercaDeActivity.this, SitiosActivity.class);
                switch (position){
                    case 0:
                        i.putExtra("sitio", "1");
                        startActivity(i);
        ...
        itemClickSupportSettings.setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                ...
                switch (position){
                    case 0:
                        AcercaDeActivity.this.startActivity(new Intent(AcercaDeActivity.this, LoginActivity.class));
                        break;
                    case 1:
                        AcercaDeActivity.this.startActivity(new Intent(AcercaDeActivity.this, AcercaDeActivity.class));
                        break;

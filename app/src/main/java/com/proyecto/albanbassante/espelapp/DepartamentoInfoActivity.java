...
public class DepartamentoInfoActivity extends ActionBarActivity implements View.OnClickListener{
    ...
    CharSequence Titles[]={"Info","Labs","Mapa"};
    int Numboftabs =3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_departamento_info);
    ...
    Handler h = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what != 1) { // code if not connected
                ...
                switch (depCodigo){
                    case "1":
                        SharedPreferences cienciasExactas = getSharedPreferences("ciencias", Context.MODE_PRIVATE);
                        if (cienciasExactas.getString("nombre", "").equals("")) {
                            Toast.makeText(getApplicationContext(), "Conéctese a internet para obtener la información", Toast.LENGTH_SHORT).show();
                        }
                        bundle.putString("id", depCodigo);
                        bundle.putString("nombre", cienciasExactas.getString("nombre", ""));
                        bundle.putString("director", cienciasExactas.getString("director",""));
                        bundle.putString("mail", cienciasExactas.getString("mail",""));
                        bundle.putString("telefono", cienciasExactas.getString("telefono",""));
                        bundle.putString("horario", cienciasExactas.getString("horario", ""));
                        bundle.putString("direccion", "");
                        break;
                    case "2":
                        SharedPreferences energiaMecanica = getSharedPreferences("energia", Context.MODE_PRIVATE);
                        if (energiaMecanica.getString("nombre", "").equals("")) {
                            Toast.makeText(getApplicationContext(), "Conéctese a internet para obtener la información", Toast.LENGTH_SHORT).show();
                        }
                        bundle.putString("id", depCodigo);
                        bundle.putString("nombre", energiaMecanica.getString("nombre", ""));
                        bundle.putString("director", energiaMecanica.getString("director",""));
                        bundle.putString("mail", energiaMecanica.getString("mail",""));
                        bundle.putString("telefono", energiaMecanica.getString("telefono",""));
                        bundle.putString("horario", energiaMecanica.getString("horario", ""));
                        bundle.putString("direccion", "");
                        break;
                    case "3":
                        SharedPreferences electricaElectronica = getSharedPreferences("electrica", Context.MODE_PRIVATE);
                        if (electricaElectronica.getString("nombre", "").equals("")) {
                            Toast.makeText(getApplicationContext(), "Conéctese a internet para obtener la información", Toast.LENGTH_SHORT).show();
                        }
                        bundle.putString("id", depCodigo);
                        bundle.putString("nombre", electricaElectronica.getString("nombre", ""));
                        bundle.putString("director", electricaElectronica.getString("director",""));
                        bundle.putString("mail", electricaElectronica.getString("mail",""));
                        bundle.putString("telefono", electricaElectronica.getString("telefono",""));
                        bundle.putString("horario", electricaElectronica.getString("horario", ""));
                        bundle.putString("direccion", "");
                        break;
                    case "4":
                        SharedPreferences lenguas = getSharedPreferences("lenguas", Context.MODE_PRIVATE);
                        if (lenguas.getString("nombre", "").equals("")) {
                            Toast.makeText(getApplicationContext(), "Conéctese a internet para obtener la información", Toast.LENGTH_SHORT).show();
                        }
                        bundle.putString("id", depCodigo);
                        bundle.putString("nombre", lenguas.getString("nombre", ""));
                        bundle.putString("director", lenguas.getString("director",""));
                        bundle.putString("mail", lenguas.getString("mail",""));
                        bundle.putString("telefono", lenguas.getString("telefono",""));
                        bundle.putString("horario", lenguas.getString("horario", ""));
                        bundle.putString("direccion", "");
                        break;
                    case "5":
                        ...
                        bundle.putString("id", depCodigo);
                        bundle.putString("nombre", entrada.getString("nombre", ""));
                        bundle.putString("director", entrada.getString("director",""));
                        bundle.putString("mail", entrada.getString("mail",""));
                        bundle.putString("telefono", entrada.getString("telefono",""));
                        bundle.putString("horario", entrada.getString("horario", ""));
                        bundle.putString("direccion", entrada.getString("direccion", ""));
                        break;
                }
    ...
    class LoadAllDepartamentos extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(DepartamentoInfoActivity.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    switch (id){
                        case "1":
                            SharedPreferences cienciasExactas = getSharedPreferences("ciencias", Context.MODE_PRIVATE);
                            SharedPreferences.Editor editorCiencias = cienciasExactas.edit();
                            editorCiencias.putString("id", id);
                            editorCiencias.putString("nombre", nombre);
                            editorCiencias.putString("director", director);
                            editorCiencias.putString("mail", mail);
                            editorCiencias.putString("telefono", telefono);
                            editorCiencias.putString("horario", horario);
                            editorCiencias.commit();
                            break;
                        case "2":
                            SharedPreferences energiaMecanica = getSharedPreferences("energia", Context.MODE_PRIVATE);
                            SharedPreferences.Editor editorEnergia = energiaMecanica.edit();
                            editorEnergia.putString("id", id);
                            editorEnergia.putString("nombre", nombre);
                            editorEnergia.putString("director", director);
                            editorEnergia.putString("mail", mail);
                            editorEnergia.putString("telefono", telefono);
                            editorEnergia.putString("horario", horario);
                            editorEnergia.commit();
                            break;
                        case "3":
                            SharedPreferences electricaElectronica = getSharedPreferences("electrica", Context.MODE_PRIVATE);
                            SharedPreferences.Editor editorElectrica = electricaElectronica.edit();
                            editorElectrica.putString("id", id);
                            editorElectrica.putString("nombre", nombre);
                            editorElectrica.putString("director", director);
                            editorElectrica.putString("mail", mail);
                            editorElectrica.putString("telefono", telefono);
                            editorElectrica.putString("horario", horario);
                            editorElectrica.commit();
                            break;
                        case "4":
                            SharedPreferences lenguas = getSharedPreferences("lenguas", Context.MODE_PRIVATE);
                            SharedPreferences.Editor editorLenguas = lenguas.edit();
                            editorLenguas.putString("id", id);
                            editorLenguas.putString("nombre", nombre);
                            editorLenguas.putString("director", director);
                            editorLenguas.putString("mail", mail);
                            editorLenguas.putString("telefono", telefono);
                            editorLenguas.putString("horario", horario);
                            editorLenguas.commit();
                            break;
                        case "5":
                            SharedPreferences entrada = getSharedPreferences("entrada", Context.MODE_PRIVATE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search) {
            Intent i = new Intent(DepartamentoInfoActivity.this, BusquedaActivity.class);
            startActivity(i);
        }
    ...
    public void setupNavigationDrawer() {
        ...
        DepartamentoInfoActivity.this.getTheme().resolveAttribute(R.attr.colorPrimaryDark, typedValue, true);
    ...
    private void setupNavigationDrawerRecyclerViews() {
        ...
        linearLayoutManager = new LinearLayoutManager(DepartamentoInfoActivity.this);
        ...
        linearLayoutManager2 = new LinearLayoutManager(DepartamentoInfoActivity.this);
        ...
        linearLayoutManager3 = new LinearLayoutManager(DepartamentoInfoActivity.this);
        ...
        linearLayoutManagerSettings = new LinearLayoutManager(DepartamentoInfoActivity.this);
        ...
        itemClickSupport1.setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                ...
                Intent i = new Intent(DepartamentoInfoActivity.this, DepartamentoInfoActivity.class);
                switch (position) {
                    case 0:
        ...
        itemClickSupport2.setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                ...
                Intent i = new Intent(DepartamentoInfoActivity.this, SitiosActivity.class);
                switch (position){
                    case 0:
                        i.putExtra("sitio", "1");
                        startActivity(i);
        ...
        itemClickSupportSettings.setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                ...
                switch (position){
                    case 0:
                        DepartamentoInfoActivity.this.startActivity(new Intent(DepartamentoInfoActivity.this, LoginActivity.class));
                        break;
                    case 1:
                        DepartamentoInfoActivity.this.startActivity(new Intent(DepartamentoInfoActivity.this, AcercaDeActivity.class));
                        break;

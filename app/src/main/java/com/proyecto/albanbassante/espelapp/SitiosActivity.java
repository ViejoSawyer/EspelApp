...
public class SitiosActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wvSitios = (WebView) findViewById(R.id.wvSitios);
        wvSitios.getSettings().setBuiltInZoomControls(true);
        wvSitios.getSettings().setSupportZoom(true);

        wvSitios.getSettings().setLoadWithOverviewMode(true);
        wvSitios.getSettings().setUseWideViewPort(true);

        //Capturar parametro
        Bundle extras = getIntent().getExtras();
        sitCodigo = extras.getString("sitio");

        switch (sitCodigo){
            case "1":
                getSupportActionBar().setTitle("Mi Espe");
                try {
                    wvSitios.loadUrl("https://miespe.espe.edu.ec/cp/home/displaylogin");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
            case "2":
                getSupportActionBar().setTitle("Moodle Espe");
                try {
                    wvSitios.loadUrl("http://webltga.espe.edu.ec/moodle/login/index.php");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
            case "3":
                getSupportActionBar().setTitle("Blog Espe");
                try {
                    wvSitios.loadUrl("http://blogs.espe.edu.ec/");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
            case "4":
                getSupportActionBar().setTitle("Agenda Telefónica Espe");
                try {
                    wvSitios.loadUrl("http://webltga.espe.edu.ec/sg-telefonia/index.php?r=guia/guiaTelefonica");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
            case "5":
                getSupportActionBar().setTitle("Quipux");
                try {
                    wvSitios.loadUrl("http://quipux.espe.edu.ec/");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
            case "6":
                getSupportActionBar().setTitle("Radio Eskpe");
                try {
                    wvSitios.loadUrl("http://radioeskpe.espe.edu.ec/");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search) {
            Intent i = new Intent(SitiosActivity.this, BusquedaActivity.class);
            startActivity(i);
        }
    ...
    public void setupNavigationDrawer() {
        ...
        SitiosActivity.this.getTheme().resolveAttribute(R.attr.colorPrimaryDark, typedValue, true);
    ...
    private void setupNavigationDrawerRecyclerViews() {
        ...
        linearLayoutManager = new LinearLayoutManager(SitiosActivity.this);
        ...
        linearLayoutManager2 = new LinearLayoutManager(SitiosActivity.this);
        ...
        linearLayoutManager3 = new LinearLayoutManager(SitiosActivity.this);
        ...
        linearLayoutManagerSettings = new LinearLayoutManager(SitiosActivity.this);
        ...
        itemClickSupport1.setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                ...
                Intent i = new Intent(SitiosActivity.this, DepartamentoInfoActivity.class);
                switch (position) {
                    case 0:
        ...
        itemClickSupport2.setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                ...
                Intent i = new Intent(SitiosActivity.this, SitiosActivity.class);
                switch (position){
                    case 0:
                        i.putExtra("sitio", "1");
                        startActivity(i);
        ...
        itemClickSupportSettings.setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                ...
                switch (position){
                    case 0:
                        SitiosActivity.this.startActivity(new Intent(SitiosActivity.this, LoginActivity.class));
                        break;
                    case 1:
                        SitiosActivity.this.startActivity(new Intent(SitiosActivity.this, AcercaDeActivity.class));
                        break;
